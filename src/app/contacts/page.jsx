  ...
  return (
    <main className="w-full h-full bg-gradient-to-r from-gray-950 via-gray-900 to-gray-800 ">
      <BackgroundBeamsWithCollision>
        <section className="flex flex-col items-center justify-center h-[1000px]">
          <div className=" flex items-center w-full max-w-6xl mx-auto ">
            ...
            ></div>
            <span className="px-3 text-4xl sm:text-5xl lg:text-6xl font-mono font-bold text-white">
              Contacts
            </span>
            <div
              className="flex-1 h-px"
