    ...
    <main className="content">
      ...
      <section
        ...
        className="relative flex flex-col xl:flex-row
                   ...
                   text-center px-5 pt-30 pb-15 overflow-hidden"
      >
        <div className="relative z-10 lg:pl-25 flex-1 flex flex-col xl:items-start items-center justify-center">
        ...
        <div className="relative z-10 flex-1 flex justify-start items-center mt-10 xl:text-left xl:mt-15">
          <div
